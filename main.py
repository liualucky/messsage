...
ttk.Label(left, text="病名清單", style="Sub.TLabel").pack(anchor="w")
...
ttk.Label(right, text="查詢結果", style="Sub.TLabel").pack(anchor="w")
...
ttk.Label(
    main,
    text="操作方式：輸入病名關鍵字後即時篩選，或先選擇分類，再點選病名查看主穴與配穴。",
    font=("Microsoft JhengHei", 10)
).grid(row=3, column=0, columnspan=5, sticky="w", pady=(16, 0))
